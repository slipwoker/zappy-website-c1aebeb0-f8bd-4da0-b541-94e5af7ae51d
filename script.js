    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אבישי עיצוב בנוף משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'c1aebeb0-f8bd-4da0-b541-94e5af7ae51d',
                    name: data.name || '',
                    email: data.email || '',
